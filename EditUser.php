    ...
    <div class= "container-fluid content-row">
        ...
        <div class="col-lg-4 vh-100">
            <div class="card">
                ...
                <li class="list-group-item text-center "> <a class="nav-link" href="AdminBook.php">View Users</a> </li>
                    <li class="list-group-item text-center "> <a class="nav-link" href="AddBook.php">Add Users</a></li>
                </ul>
            </div>
        </div>
                ...
                <div class="card-header bg-success">
                    ...
                    <div class="card-body text-center">  
                        ...
                        <?php
                            ...
                            <p>Image Name:<br>
                            <input type=\"text\" name=\"Genre\" value='" . $row['img'] ."'>
                            </p>

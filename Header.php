<!DOCTYPE html> 
<!--the header that each file will have with buttons and banners-->
<div class="well text-center bg-dark text-white">Open from 8am - 5pm at 12345 Example St. IN</div> <!-- banner at top of page-->
    ...
    <div class="row">
        ...
        <div class="col-sm-2"> <!--spaces out buttons-->
